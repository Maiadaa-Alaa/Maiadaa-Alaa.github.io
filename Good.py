...
class MessageHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        self.send_header('Location', 'http://languagenut.s3-website.eu-north-1.amazonaws.com/.html')
        self.end_headers()
    ...
    def do_GET(self):
        if self.path == '/':
            ...
            with open("DB.txt", "r") as f:
                ...
                self.send_header('Access-Control-Allow-Methods', 'GET')  # Allow only GET method
